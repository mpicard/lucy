...
class MacdHyperopt(IHyperOpt):
    ...
    def generate_roi_table(params: dict) -> dict[int, float]:
        ...
        roi_table[params["roi_t10"] + params["roi_t9"]] = (
            params["roi_p1"]
            + params["roi_p2"]
            + params["roi_p3"]
            + params["roi_p4"]
        ...
        roi_table[params["roi_t10"] + params["roi_t9"] + params["roi_t8"]] = (
            params["roi_p1"]
            + params["roi_p2"]
            + params["roi_p3"]
            + params["roi_p4"]
        ...
        roi_table[
            params["roi_t10"] + params["roi_t9"] + params["roi_t8"] + params["roi_t7"]
        ] = (
            params["roi_p1"]
            + params["roi_p2"]
            + params["roi_p3"]
    ...
    def indicator_space() -> List[Dimension]:
        return [Integer(0, 50, name="buy-rsi-value")]
    ...
    def sell_strategy_generator(params: Dict[str, Any]) -> Callable:
        def populate_sell_trend(dataframe: DataFrame, metadata: dict) -> DataFrame:
            dataframe.loc[
                (
                    (dataframe["sell-rsi"].rolling(8).max() > params["sell-rsi-value"])
                    & (dataframe["macd"] > 0)
                    & (
    ...
    def sell_indicator_space() -> List[Dimension]:
        return [Integer(50, 100, name="sell-rsi-value")]
